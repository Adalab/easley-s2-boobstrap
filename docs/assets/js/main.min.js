...
const btnCardCreated = document.querySelector('.collapsible__content-button');
...
function send() {
  fetch('https://us-central1-awesome-cards-cf6f0.cloudfunctions.net/card/', {
    ...
    .then(url => {
      ...
      btnCardCreated.style.backgroundColor = '#d5d5d5';
    });
};
btnCardCreated.addEventListener('click', send);
